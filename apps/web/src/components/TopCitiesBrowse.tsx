  ...
  return (
    <section aria-labelledby="city-browse-heading" className={className}>
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Where the tech companies in the directory are based, remote included.
      </p>
          ...
          <li key={city.name}>
            ...
            >
              {city.imageSrc ? (
                ...
                <div
                  aria-hidden="true"
                  className="absolute inset-0 bg-linear-to-br from-primary/70 via-primary/40 to-muted transition-transform duration-500 ease-out motion-safe:group-hover:scale-105"
                />
              )}
