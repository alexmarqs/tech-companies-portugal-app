  ...
  return (
    <section className="mx-auto flex w-full max-w-5xl p-3 relative flex-1">
      <div className="flex flex-col w-full">
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-emerald-50/80 via-background to-amber-50/40 border border-border/40 px-6 py-8 sm:px-8 sm:py-10 mb-6">
